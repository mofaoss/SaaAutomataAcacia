...
class Config(QConfig):
    ...
    daily_task_sequence = ConfigItem("DailyTasks", "TaskSequence", [
        {"id": "task_login", "enabled": True, "use_periodic": False,
        ...
        {"id": "task_supplies", "enabled": True, "use_periodic": False,
            "activation_config": [{"type": "daily", "day": 0, "time": "00:00", "max_runs": 1}],
         "execution_config": [{"type": "daily", "day": 0, "time": "00:00", "max_runs": 1}], "last_run": 0},
        {"id": "task_shop", "enabled": True, "use_periodic": False,
            "activation_config": [{"type": "daily", "day": 0, "time": "00:00", "max_runs": 1}],
         "execution_config": [{"type": "daily", "day": 0, "time": "00:00", "max_runs": 1}], "last_run": 0},
        {"id": "task_stamina", "enabled": True, "use_periodic": False,
            "activation_config": [{"type": "daily", "day": 0, "time": "00:00", "max_runs": 1}],
         "execution_config": [{"type": "daily", "day": 0, "time": "00:00", "max_runs": 1}], "last_run": 0},
        ...
        {"id": "task_operation", "enabled": False, "use_periodic": False,
            "activation_config": [{"type": "daily", "day": 0, "time": "00:00", "max_runs": 1}],
         "execution_config": [{"type": "daily", "day": 0, "time": "00:00", "max_runs": 1}], "last_run": 0},
        {"id": "task_reward", "enabled": True, "use_periodic": False,
            "activation_config": [{"type": "daily", "day": 0, "time": "00:00", "max_runs": 1}],
         "execution_config": [{"type": "daily", "day": 0, "time": "00:00", "max_runs": 1}], "last_run": 0},
    ...
    # Cache for GitHub API to prevent rate limits and root directory clutter
