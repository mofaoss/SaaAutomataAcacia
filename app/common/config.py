...
class Config(QConfig):
    ...
    daily_task_sequence = ConfigItem("DailyTasks", "TaskSequence", [
        ...
        {"id": "task_chasm", "enabled": False, "use_periodic": True,
            "activation_config": [{"type": "weekly", "day": 0, "time": "00:00", "max_runs": 1}],
         "execution_config": [{"type": "weekly", "day": 0, "time": "00:00", "max_runs": 1}], "last_run": 0},
        {"id": "task_operation", "enabled": False, "use_periodic": True,
            "activation_config": [{"type": "daily", "day": 0, "time": "00:00", "max_runs": 1}],
         "execution_config": [{"type": "daily", "day": 0, "time": "00:00", "max_runs": 1}], "last_run": 0},
